...
from wtforms.validators import DataRequired, Length, Email, EqualTo, ValidationError, Optional, Required
...
class UpdateAccountForm(FlaskForm):
	...
	role = SelectField('Выбрать роль', choices=[("разработчик, разработчик"), ("архитектор", "архитектор"), ("аналитик", "аналитик")])
	temp = TextField('Ваша должность')
